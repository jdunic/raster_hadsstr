...
SSTAvgOverYears2 <- getSSTAvgOverYears(hadsst_raster = b, years = 1990:2011)
...
Yay!!! They match. Though the time savings are smaller than expected - lm is probably the bottleneck? So not much can be done?
